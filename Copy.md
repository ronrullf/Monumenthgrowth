...
### How It Works — Content → Leads → Booked Jobs
...
>
> **[NEEDS PROOF] Testimonial:** _Insert one real contractor quote with name, company, and location._
>
> **Button:** Get in touch
...
## 3. CTA Coverage Check

| Section | Drives to "Get in touch"? |
|---|---|
| Hero | ✅ |
| Problem / Agitation | ✅ |
| How It Works | ✅ |
...
## 4. Open Questions / [NEEDS PROOF]

1. **Results data** — real, publishable numbers for the Proof section (jobs booked, views, lead volume, or a named client outcome).
2. **Testimonial** — at least one contractor quote with name, company, and location.
3. **Pricing** — the package price for the Offer section (not defined in the brief).
4. **Guarantee** — whether any guarantee (e.g. results, refund, minimum leads) is offered; if so, exact terms.
5. **Onboarding specifics** — how footage is submitted and turnaround time, if you want to strengthen the "How It Works" step 1.
6. **Sector scope** — brief says kitchen & bath specifically; confirm whether adjacent remodeling trades (e.g. full-home) should be named or excluded.
